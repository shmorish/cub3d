...
/*   Updated: 2023/11/08 17:53:15 by morishitash      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_texture(t_parser *parser)
{
	...
	printf("parser->north_texture: [%s]\n", parser->north_texture);
	printf("parser->south_texture: [%s]\n", parser->south_texture);
	printf("parser->west_texture: [%s]\n", parser->west_texture);
	printf("parser->east_texture: [%s]\n", parser->east_texture);
	printf("parser->sprite_texture: [%s]\n", parser->sprite_texture);
}
